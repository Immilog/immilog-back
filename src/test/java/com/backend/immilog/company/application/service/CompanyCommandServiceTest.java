...
class CompanyCommandServiceTest {
    ...
    void shouldUpdateExistingCompany() {
        ...
        Company existingCompany = new Company(1L, manager, metaData);
    ...
    void shouldCallRepositorySaveWhenSavingNewCompany() {
        // given
        CompanyManager manager = CompanyManager.of(Country.JAPAN, "도쿄", 2L);
        ...
        Company savedCompany = new Company(2L, manager, metaData);
    ...
    void shouldCallRepositoryDeleteWhenDeletingCompany() {
        ...
        Company companyToDelete = new Company(3L, manager, metaData);
    ...
    void shouldReturnCorrectCompanyInformationAfterSave() {
        // given
        CompanyManager manager = CompanyManager.of(Country.SOUTH_KOREA, "대구", 4L);
        ...
        Company company = new Company(null, manager, metaData);
        Company savedCompany = new Company(4L, manager, metaData);
        ...
        // then
        assertThat(result.seq()).isEqualTo(4L);
        ...
        assertThat(result.managerUserSeq()).isEqualTo(4L);
    }
}